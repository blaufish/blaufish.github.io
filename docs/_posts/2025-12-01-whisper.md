...
I ran OpenAI Whisper on Säkerhetspodcasten, a podcast in the Swedish language.
300+ podcasts episodes, typically a little less than an hour per episode.
I spoke about this a bit in
  [Säkerhetspodcasten #292 - Ostrukturerat V.46](https://sakerhetspodcasten.se/posts/sakerhetspodcasten_292_ostrukturerat_v_46/)
...
* [Insane and odd forigin characters](#insane-and-odd-forigin-characters)
...
Anecdotal non-scientific observations from using Google and Whisper with
  default settings, minimal configuration, on Säkerherspodcasten:
...
## Insane and odd forigin characters
